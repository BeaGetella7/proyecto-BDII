...
-- 5. dim_tarifa_pago
-- id_tarifa es el surrogate key (1-7)
-- ratecode_id es el código original del dataset (1,2,3,4,5,6,99)
...
CREATE TABLE IF NOT EXISTS fact_viajes (
    ...
    id_tarifa             INT       NOT NULL REFERENCES dim_tarifa_pago(id_tarifa),
